...
def add_exception_handlers(app: FastAPI) -> None:
    ...
    async def handle_user_not_found_exception(request: Request, exc: UserNotFound) -> JSONResponse:
    ...
    async def handle_user_already_exists_exception(request: Request, exc: UserAlreadyExists) -> JSONResponse:
    ...
    async def handle_integrity_error_exception(request: Request, exc: IntegrityError) -> JSONResponse:
